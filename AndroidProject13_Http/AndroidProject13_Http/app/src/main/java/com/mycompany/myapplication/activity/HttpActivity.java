...
public class HttpActivity extends AppCompatActivity {
    ...
    public void handleBtnGet(View v) throws IOException {
        String url = "http://192.168.3.128:8080/IoTWebProgramming/http/exam03";
    ...
    public void handleBtnMultipart(View v) {
        ...
        String url = "http://192.168.3.128:8080/IoTWebProgramming/http/exam04";
    ...
    public void handleBtnWebSocketOpen(View v) {
        String url = "ws://192.168.3.128:8080/SensingCarRemoteWebControl/websocket/thermistorsensor";
        Request request = new Request.Builder()
                .url(url)
                .build();
        OkHttpClient client = new OkHttpClient();
    ...
    public void handleBtnChangeAngle(View v) {
        String url = "http://192.168.3.128:8080/SensingCarRemoteWebControl/ultrasonicsensor";
        RequestBody requestBody = new FormBody.Builder()
                .add("command", "change")
